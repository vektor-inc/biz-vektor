...
if ( $options['top3PrDisplay'] ) {
	?>
  checked<?php } ?>> <?php _e( 'Do not show the top 3PR area', 'biz-vektor' ); ?></p></td>
</tr>
</table>
...
<h3>
<?php
if ( isset( $options['infoLabelName'] ) && ! empty( $options['infoLabelName'] )
...
if ( $options['topSideBarDisplay'] ) {
	?>
  checked<?php } ?>> <?php _e( 'I want to hide the sidebar', 'biz-vektor' ); ?></p></td>
</tr>
...
<tr>
	...
	<?php
	$postLabelName = esc_html( bizVektorOptions( 'postLabelName' ) );
	printf( __( 'Display a number of %s posts', 'biz-vektor' ), $postLabelName );
	?>
	</th>
	<td><a href="#postSetting">
		...
		$infoLabelName = esc_html( bizVektorOptions( 'infoLabelName' ) );
		$postLabelName = esc_html( bizVektorOptions( 'postLabelName' ) );
		printf( __( 'Please set from the [ Setting the %1$s and %2$s ] section.', 'biz-vektor' ), $infoLabelName, $postLabelName );
		?>
		</a>
	</td>
</tr>
...
printf( __( '%s will be displayed if the slideshow is not set.', 'biz-vektor' ), $topVisualLink );
?>
<br />
...
?>
> <?php _e( 'Open in a blank window', 'biz-vektor' ); ?></label>
</td>
</tr>
<?php
	$i++;

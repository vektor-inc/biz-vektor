...
function biz_vektor_info_get_archives_link( $link_html ) {
	...
	if ( $my_archives_post_type != '' ) {
		...
		if ( preg_match( '/post_type=/', $link_html ) ) {
			return $link_html;
		}
...
<tr>
	...
	<dd>
	<?php
	if ( ! isset( $options['listInfoTop'] ) ) {
		$options['listInfoTop'] = 'listType_set'; }
	?>
	...
	<dd>
	<?php
	if ( ! isset( $options['listInfoArchive'] ) ) {
		$options['listInfoArchive'] = 'listType_set'; }
	?>

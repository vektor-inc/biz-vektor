...
class WP_Widget_infoTerms extends WP_Widget {
	...
	function WP_Widget_infoTerms() {
		...
		$widget_name = $lab.'_'.sprintf( __( '%s category', 'biz-vektor' ),$biz_vektor_options['infoLabelName'] );
...
class WP_Widget_infoArchives extends WP_Widget {
	...
	function WP_Widget_infoArchives() {
		...
		$widget_name = $lab.'_'.sprintf( __( '%s Yearly archives', 'biz-vektor' ),$biz_vektor_options['infoLabelName'] );

...
if (!class_exists('Vk_post_type_manager')) {
    class Vk_post_type_manager
    {
        ...
        /*-------------------------------------------*/
        public function add_post_type_post_type_manage()
        {
        ...
        /*-------------------------------------------*/
        public function add_cap_post_type_manage()
        {
        ...
        public function add_meta_box_action()
        {
            global $vk_post_type_manager_textdomain;
            global $post;
        ...
        public function save_cf_value($post_id)
        {
            global $post;
        ...
        public function add_post_notice()
        {
            global $pagenow;
            global $vk_post_type_manager_textdomain;

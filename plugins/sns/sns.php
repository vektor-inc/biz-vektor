...
function biz_vektor_ogp()
{
    ...
    if (is_front_page() || is_home()) {
        ...
        } elseif (isset($options['ogpImage']) && $options['ogpImage']) {
            $bizVektorOGP .= '<meta property="og:image" content="'.$options['ogpImage'].'" />'."\n";
        }
        // description
...
function biz_vektor_fbLikeBox()
{
    ...
    if (isset($biz_vektor_options['fbLikeBoxHideCover']) && $biz_vektor_options['fbLikeBoxHideCover']) :
        $biz_vektor_options['fbLikeBoxHideCover'] = 'true'; else :
    ...
    if (isset($biz_vektor_options['fbLikeBoxHeight']) && $biz_vektor_options['fbLikeBoxHeight']) :
        $fbLikeBoxHeight = 'data-height="'.esc_attr($biz_vektor_options['fbLikeBoxHeight']).'" '; else :
        $fbLikeBoxHeight = '';
    endif;
...
function biz_vektor_snsBnrs()
{
    ...
    if (isset($options['facebook'])) : $facebook = $options['facebook']; else : $facebook = '';
    endif;
    if (isset($options['twitter'])) : $twitter = $options['twitter']; else : $twitter = '';
    endif;
    if ($facebook || $twitter) {
...
<ul>
<li><label><input type="checkbox" name="biz_vektor_theme_options[snsBtnsFront]" id="snsBtnsFront" value="false" <?php if ($options['snsBtnsFront']) {
        ?> checked<?php 
    } ?>> 
	<?php _ex('Home page', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[snsBtnsPage]" id="snsBtnsPage" value="false" <?php if ($options['snsBtnsPage']) {
        ?> checked<?php 
    } ?>> 
	<?php _ex('Page', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[snsBtnsPost]" id="snsBtnsPost" value="false" <?php if ($options['snsBtnsPost']) {
        ?> checked<?php 
    } ?>> 
	<?php echo esc_html($options['postLabelName']); ?> <?php _ex('Post', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[snsBtnsInfo]" id="snsBtnsInfo" value="false" <?php if ($options['snsBtnsInfo']) {
        ?> checked<?php 
    } ?>> 
...
<ul>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbCommentsFront]" id="fbCommentsFront" value="false" <?php if ($options['fbCommentsFront']) {
        ?> checked<?php 
    } ?>>
	<?php _ex('Home page', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbCommentsPage]" id="fbCommentsPage" value="false" <?php if ($options['fbCommentsPage']) {
        ?> checked<?php 
    } ?>> 
	<?php _ex('Page', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbCommentsPost]" id="fbCommentsPost" value="false" <?php if ($options['fbCommentsPost']) {
        ?> checked<?php 
    } ?>> 
	<?php echo esc_html($options['postLabelName']); ?> <?php _ex('Post', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbCommentsInfo]" id="fbCommentsInfo" value="false" <?php if ($options['fbCommentsInfo']) {
        ?> checked<?php 
    } ?>> 
	<?php echo esc_html($options['infoLabelName']); ?> <?php _ex('Post', 'sns display', 'biz-vektor'); ?></label></li>
</ul>
...
<ul>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbLikeBoxFront]" id="fbLikeBoxFront" value="false" <?php if ($options['fbLikeBoxFront']) {
        ?> checked<?php 
    } ?>> 
	<?php _ex('Home page', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbLikeBoxPage]" id="fbLikeBoxPage" value="false" <?php if ($options['fbLikeBoxPage']) {
        ?> checked<?php 
    } ?>> 
	<?php _ex('Page', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbLikeBoxPost]" id="fbLikeBoxPost" value="false" <?php if ($options['fbLikeBoxPost']) {
        ?> checked<?php 
    } ?>> 
	<?php echo esc_html($options['postLabelName']); ?> <?php _ex('Post', 'sns display', 'biz-vektor'); ?></label></li>
<li><label><input type="checkbox" name="biz_vektor_theme_options[fbLikeBoxInfo]" id="fbLikeBoxInfo" value="false" <?php if ($options['fbLikeBoxInfo']) {
        ?> checked<?php 
    } ?>>
	<?php echo esc_html($options['infoLabelName']); ?> <?php _ex('Post', 'sns display', 'biz-vektor'); ?></label></li>
</ul>
...
<dd><label><input type="checkbox" name="biz_vektor_theme_options[fbLikeBoxStream]" id="fbLikeBoxStream" value="false" <?php if ($options['fbLikeBoxStream']) {
        ?> checked<?php 
    } ?>> <?php _e('Display', 'biz-vektor'); ?></label></dd>

...
function biz_vektor_default_design_WpHead()
{
    if (is_bizvektor_default_design()) {
        ...
        if (!isset($default_design_options['theme_plusKeyColor']) || $default_design_options['theme_plusKeyColor'] == '') {
            $default_design_options['theme_plusKeyColor'] = '#c30000';
        }
        if (!isset($default_design_options['theme_plusKeyColorLight']) || $default_design_options['theme_plusKeyColorLight'] == '') {
            $default_design_options['theme_plusKeyColorLight'] = '#ff0000';
        }
        if (!isset($default_design_options['theme_plusKeyColorDark']) || $default_design_options['theme_plusKeyColorDark'] == '') {

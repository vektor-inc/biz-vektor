...
});}});jQuery("iframe").each(function(e){var d=jQuery(this).attr("src");if(!d){return;}idx=d.indexOf("youtube");if(idx!=-1){jQuery(this).addClass("iframeYoutube").css({"max-width":"100%"});
...
window.onload=function(){if(!document.getElementById){return;}var c=new Array();var b;var a=function(k){for(var g=0;g<k.length;g++){if(k[g].className.match(/(^| )imgover( |$)/i)){var j=k[g].getAttribute("src");
